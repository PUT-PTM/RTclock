...
static void TM_I2C1_INT_InitPins(TM_I2C_PinsPack_t pinspack) {
	...
	if (pinspack == TM_I2C_PinsPack_1) {
		TM_GPIO_InitAlternate(GPIOB, GPIO_Pin_6 | GPIO_Pin_7, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_2) {
		TM_GPIO_InitAlternate(GPIOB, GPIO_Pin_8 | GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C1);
	}
#endif
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_3) {
		TM_GPIO_InitAlternate(GPIOB, GPIO_Pin_6 | GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C1);
	}
#endif
...
#if defined(GPIOB)
	if (pinspack == TM_I2C_PinsPack_1) {
		TM_GPIO_InitAlternate(GPIOB, GPIO_Pin_10 | GPIO_Pin_11, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOF)
	if (pinspack == TM_I2C_PinsPack_2) {
		TM_GPIO_InitAlternate(GPIOF, GPIO_Pin_0 | GPIO_Pin_1, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C2);
	}
#endif
#if defined(GPIOH)
	if (pinspack == TM_I2C_PinsPack_3) {
		TM_GPIO_InitAlternate(GPIOH, GPIO_Pin_4 | GPIO_Pin_5, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C2);
	}
#endif
	if (pinspack == TM_I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
...
static void TM_I2C3_INT_InitPins(TM_I2C_PinsPack_t pinspack) {
	...
	if (pinspack == TM_I2C_PinsPack_1) {
		TM_GPIO_InitAlternate(GPIOA, GPIO_Pin_8, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C3);
		TM_GPIO_InitAlternate(GPIOC, GPIO_Pin_9, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C3);
	}
#endif
#if defined(GPIOH)
	if (pinspack == TM_I2C_PinsPack_2) {
		TM_GPIO_InitAlternate(GPIOH, GPIO_Pin_7 | GPIO_Pin_8, GPIO_OType_OD, GPIO_PuPd_UP, GPIO_Speed_50MHz, GPIO_AF_I2C3);
	}
#endif
	if (pinspack == TM_I2C_PinsPack_Custom) {
		/* Init custom pins, callback function */
